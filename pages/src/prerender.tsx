 ...
 * Prerender the page.
 *
 * @param hash Render as if the address carried this hash. Left out, the markup is the overview —
 * what `index.html` ships inside `#root` and the browser half hydrates; given, it is one page's

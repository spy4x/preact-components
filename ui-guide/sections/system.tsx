  ...
  return (
    <div class="space-y-3" data-e2e="sw-quiet">
      <p class="text-xs text-gray-500 dark:text-gray-400">
        ...
        which takes no space and paints nothing. Press the button to make an update ready inside
        that same element.
      </p>
